...
class Media {
  ...
  onResize({ screen, viewport }: { screen?: ScreenSize; viewport?: Viewport } = {}) {
    ...
    // Calculate width to fit exactly `itemsPerView` items
    const padding = 2;
    const totalPadding = (this.itemsPerView - 1) * padding;
    const itemWidth = (this.viewport.width - totalPadding) / this.itemsPerView;
    this.plane.scale.x = itemWidth;
...
export default function CircularGallery({
  ...
  }, [items, bend, textColor, borderRadius, font, fontUrl, scrollSpeed, scrollEase, itemsPerView]);
  return (
    <div
